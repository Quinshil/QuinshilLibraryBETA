game.StarterGui:SetCore("SendNotification", {
	Title = "Quinshil Library [BETA]",
	Text = "Made By: Quinshil                               Library still in progress.",
	Duration = 10
})
-- Services
...
function Library:CreateLib(brackets)
	...
	do
		...
		GUI["1"]["Name"] = [[Quinshil (BETA)]];

		-- StarterGui.Quinshil.Drag
		...
		-- StarterGui.Quinshil.HideFrames
		...
		-- StarterGui.Quinshil.Main.UICorner
		GUI["3"] = Instance.new("UICorner", GUI["2"]);
		GUI["3"]["CornerRadius"] = UDim.new(0, 6);

		-- StarterGUI.Quinshil.Main.ContentContainer
		...
		-- StarterGUI.Quinshil.Main.ContentContainer.UIPadding
		...
		-- StarterGUI.Quinshil.Main.ContentContainer.Fade
		...
		-- StarterGUI.Quinshil.Main.ContentContainer.Fade.UIGradient
		...
		-- StarterGui.Quinshil.Main.TopBar
		...
		-- StarterGui.Quinshil.Main.TopBar.UICorner
		GUI["6"] = Instance.new("UICorner", GUI["5"]);

		-- StarterGui.Quinshil.Main.TopBar.Extension
		...
		-- StarterGui.Quinshil.Main.TopBar.Title
		...
		-- StarterGui.Quinshil.Main.TopBar.Close
		...
		-- StarterGui.Quinshil.Main.DropShadowHolder
		...
		-- StarterGui.Quinshil.Main.DropShadowHolder.DropShadow
	...
	-- Navigation
	do
		-- StarterGui.Quinshil.Main.Navigation
		...
		-- StarterGui.Quinshil.Main.Navigation.UICorner
		GUI["e"] = Instance.new("UICorner", GUI["d"]);
		GUI["e"]["CornerRadius"] = UDim.new(0, 6);

		-- StarterGui.Quinshil.Main.Navigation.ButtonHolder
		...
		-- StarterGui.Quinshil.Main.Navigation.Hide2
		...
		-- StarterGui.Quinshil.Main.Navigation.Line
	...
	function GUI:NewTab(brackets)
		...
		-- Render
		do
			-- StarterGui.Quinshil.Main.Navigation.ButtonHolder.Inactive
			...
			-- StarterGui.Quinshil.Main.Navigation.ButtonHolder.Inactive.UIPadding
			Tab["12"] = Instance.new("UIPadding", Tab["11"]);
			Tab["12"]["PaddingLeft"] = UDim.new(0, 28);

			-- StarterGui.Quinshil.Main.Navigation.ButtonHolder.Inactive.extension
			...
			-- StarterGui.Quinshil.Drag.Main.ContentContainer.HomeTab
			...
			-- StarterGui.Quinshil.Main.ContentContainer.HomeTab.UIListLayout
			Tab["24"] = Instance.new("UIListLayout", Tab["1c"]);
			Tab["24"]["Padding"] = UDim.new(0, 6);
			Tab["24"]["SortOrder"] = Enum.SortOrder.LayoutOrder;

			-- StarterGUI.Quinshil.Main.ContentContainer.HomeTab.UIPadding
		...
		function Tab:NewButton(brackets)
			...
			--Render
			do
				-- StarterGui.Quinshil.Main.ContentContainer.HomeTab.Button
				...
				-- StarterGui.Quinshil.Main.ContentContainer.HomeTab.Button.UICorner
				Button["1e"] = Instance.new("UICorner", Button["1d"]);
				Button["1e"]["CornerRadius"] = UDim.new(0, 4);

				-- StarterGui.Quinshil.Main.ContentContainer.HomeTab.Button.UIPadding
				...
				-- StarterGui.Quinshil.Main.ContentContainer.HomeTab.Button.UIStroke
				...
				-- StarterGui.Quinshil.Main.ContentContainer.HomeTab.Button.cursor
				...
				-- StarterGui.Quinshil.Main.ContentContainer.HomeTab.Button.Title
		...
		function Tab:NewLabel(brackets)
			...
			-- Render
			do
				-- StarterLabel.Quinshil.Main.ContentContainer.HomeTab.Label
				Label["19"] = Instance.new("Frame", Tab["1c"]);
				Label["19"]["BackgroundColor3"] = Color3.fromRGB(101, 49, 6);
				Label["19"]["Size"] = UDim2.new(1, 0, 0, 26);
				Label["19"]["Name"] = [[Label]];

				-- StarterLabel.Quinshil.Main.ContentContainer.HomeTab.Label.UICorner
				Label["20"] = Instance.new("UICorner", Label["19"]);
				Label["20"]["CornerRadius"] = UDim.new(0, 4);

				-- StarterLabel.Quinshil.Main.ContentContainer.HomeTab.Label.UIPadding
				...
				-- StarterLabel.Quinshil.Main.ContentContainer.HomeTab.Label.UIStroke
				...
				-- StarterLabel.Quinshil.Main.ContentContainer.HomeTab.Label.chat
				...
				-- StarterLabel.Quinshil.Main.ContentContainer.HomeTab.Label.Title
		...
		function Tab:NewSlider(brackets)
			...
			-- Render
			do
				-- StarterGui.Quinshil.Main.ContentContainer.HomeTab.Slider
				...
				-- StarterGui.Quinshil.Main.ContentContainer.HomeTab.Slider.UICorner
				Slider["26"] = Instance.new("UICorner", Slider["25"]);
				Slider["26"]["CornerRadius"] = UDim.new(0, 4);

				-- StarterGui.Quinshil.Main.ContentContainer.HomeTab.Slider.UIPadding
				...
				-- StarterGui.Quinshil.Main.ContentContainer.HomeTab.Slider.UIStroke
				...
				-- StarterGui.Quinshil.Main.ContentContainer.HomeTab.Slider.SliderBack
				...
				-- StarterGui.Quinshil.Main.ContentContainer.HomeTab.Slider.SliderBack.UICorner
				Slider["30"] = Instance.new("UICorner", Slider["29"]);
				Slider["30"]["CornerRadius"] = UDim.new(0, 6);

				-- StarterGui.Quinshil.Main.ContentContainer.HomeTab.Slider.SliderBack.UIStroke
				...
				-- StarterGui.Quinshil.Main.ContentContainer.HomeTab.Slider.SliderBack.Draggable
				...
				-- StarterGui.Quinshil.Main.ContentContainer.HomeTab.Slider.SliderBack.Draggable.UICorner
				Slider["33"] = Instance.new("UICorner", Slider["32"]);
				Slider["33"]["CornerRadius"] = UDim.new(0, 6);

				-- StarterGui.Quinshil.Main.ContentContainer.HomeTab.Slider.Title
				...
				-- StarterGui.Quinshil.Main.ContentContainer.HomeTab.Slider.Value
		...
		function Tab:NewToggle(brackets)
			...
			-- Render
			do
				-- StarterGui.Quinshil.Main.ContentContainer.HomeTab.ToggleInActive
				...
				-- StarterGui.Quinshil.Main.ContentContainer.HomeTab.ToggleInActive.UICorner
				Toggle["36"] = Instance.new("UICorner", Toggle["35"]);
				Toggle["36"]["CornerRadius"] = UDim.new(0, 2);

				-- StarterGui.Quinshil.Main.ContentContainer.HomeTab.ToggleInActive.UIPadding
				...
				-- StarterGui.Quinshil.Main.ContentContainer.HomeTab.ToggleInActive.UIStroke
				...
				-- StarterGui.Quinshil.Main.ContentContainer.HomeTab.ToggleInActive.CheckmarkHolder
				...
				-- StarterGui.Quinshil.Main.ContentContainer.HomeTab.ToggleInActive.CheckmarkHolder.UICorner
				Toggle["40"] = Instance.new("UICorner", Toggle["39"]);
				Toggle["40"]["CornerRadius"] = UDim.new(0, 4);

				-- StarterGui.Quinshil.Main.ContentContainer.HomeTab.ToggleInActive.CheckmarkHolder.UIStroke
				...
				-- StarterGui.Quinshil.Main.ContentContainer.HomeTab.ToggleInActive.CheckmarkHolder.done
				...
				-- StarterGui.Quinshil.Main.ContentContainer.HomeTab.ToggleInActive.Title
